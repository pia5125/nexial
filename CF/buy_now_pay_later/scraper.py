"""
Buy Now Pay Later Scraper - Cloudflare R2 Version
Scrapes https://www.sheeel.com/ar/sales-5.html with pagination
...
class BuyNowPayLaterScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None):
        self.base_url = "https://www.sheeel.com/ar/sales-5.html"
        self.category = "buy_now_pay_later"
        self.products = []
    ...
    def scrape_all_pages(self):
        print("\n" + "="*70)
        print("🚀 BUY NOW PAY LATER SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"buy_now_pay_later_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"buy_now_pay_later_{timestamp}.xlsx"
    ...
    def run(self):
        print("\n" + "="*70)
        print("💳 BUY NOW PAY LATER SCRAPER - CLOUDFLARE R2")
        print("="*70)
